...
import com.jiang.log.annotation.OperLog;
import com.jiang.log.enums.BusinessStatus;
...
public class OperLogAspect {
    // 配置织入点
    @Pointcut("@annotation(com.jiang.log.annotation.OperLog)")
