package com.jiang.commonredis.aspect;

import com.jiang.commonredis.annotation.RedisCache;
import com.jiang.commonredis.annotation.RedisEvict;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.jiang.commonredis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(com.jiang.commonredis.annotation.RedisEvict)")
